...
public record EventInfo(int id, @NotNull String name, @NotNull String description, @Nullable FlexiDateTime postedDate,
						@Nullable PersonLink postedBy, @NotNull FlexiDateTime eventDateInfo, @NotNull Set<TagLink> tagLinks,
						@NotNull Set<PersonLink> relatedPersonLinks, @NotNull List<ChangeInfo> changeInfos,
						@NotNull Set<EventLink> relatedEventLinks, @Nullable String details) implements Idable{
	public EventInfo(int id, @NotNull String name, @NotNull String description, @Nullable FlexiDateTime postedDate,
		...
		this.relatedPersonLinks = Collections.unmodifiableSet(relatedPersonLinks);
