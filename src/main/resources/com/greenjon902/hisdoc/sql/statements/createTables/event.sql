CREATE TABLE IF NOT EXISTS {prefix}Event (
    ...
    eventDateDate2     DATE,  -- The second date for when type is 'b'
    ...
    CONSTRAINT CheckDate_c_date2     CHECK ((eventDateType = 'c') = (eventDateDate2 IS NULL)),
    ...
    CONSTRAINT CheckDate_b_date2     CHECK ((eventDateType = 'b') = (eventDateDate2 IS NOT NULL))
);