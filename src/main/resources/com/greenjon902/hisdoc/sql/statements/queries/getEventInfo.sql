...
SELECT {prefix}EventUserRelation.uid, {prefix}User.userType, {prefix}User.userData
...
SELECT {prefix}ChangeLog.description, {prefix}ChangeLog.authorUid, {prefix}User.userType, {prefix}User.userData, {prefix}ChangeLog.date
